...
class BlogController extends Controller{
    async createBlog(req , res , next) {
        try {
            ...
            // first validation data from body
            ...
            const blog = await BlogModel.create({title , text ,image , short_text , category , tags, author})
            ...
            // use for delete file or image if we have error
            next(error)
        }
    }
